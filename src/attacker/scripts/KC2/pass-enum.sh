...
USERNAMES="${USERNAMES:-admin administrator user test guest info root sysadmin support service manager operator developer webmaster administrator1 \
...
PASSWORDS="${PASSWORDS:-123456 123456789 qwerty password 111111 12345678 abc123 1234567 password1 12345 1234567890 123123 000000 iloveyou 1234 \
