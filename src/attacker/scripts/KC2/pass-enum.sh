...
USERNAMES="admin administrator user test guest info root sysadmin support service manager operator developer webmaster administrator1 \
...
vpn vpn1 vpn2 ssh sshd ftpuser sftpuser db dbadmin dbuser sql $REGISTRY_USER"
