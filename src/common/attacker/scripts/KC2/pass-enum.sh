...
REGISTRY_NAME="${4:-${REGISTRY_NAME:-registry}}"
REGISTRY_PORT="${5:-${REGISTRY_PORT:-5000}}"
REGISTRY_ENDPOINT="${REGISTRY_NAME}:${REGISTRY_PORT}"
CATALOG_URL="https://${REGISTRY_ENDPOINT}/v2/_catalog"
...
qwe123 7777777 qwerty123 target123 tinkle 987654321 qwerty1 222222 zxcvbnm 1g2w3e4r gwerty zag12wsx gwerty123 555555 112233 asdfghjkl \
1q2w3e 123123123 qazwsx computer 12345a ashley 159753 michael football 1234qwer iloveyou1 aaaaaa 789456123 daniel \
...
if [ "$found" -ne 1 ]; then
  echo "No valid registry credentials found for ${REGISTRY_ENDPOINT}" >&2
  exit 1
fi
