#!/usr/bin/env python3
"""Python entrypoint for MITM-attack.sh."""
...
/opt/caldera/KC2/nmap-enum.py $DATA_PATH/KC5
/opt/caldera/KC2/arp-spoof.py "$IPAPI" "/tmp/iphost" "$DATA_PATH/KC5/node_traffic" "$DATA_PATH/KC5/tcpdump_stdout_err.log" "worker" $PIDFILE
