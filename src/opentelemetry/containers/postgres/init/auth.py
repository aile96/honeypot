...
try:
    ...
    if not isinstance(data, list):
        raise ValueError("users.json must be a list of user objects")
...
-- Minimal schema for testing (plaintext passwords, DO NOT use in production)
...
""")
    ...
    for u in data:
        # expected fields in the new format
        ...
        # skip records without minimal credentials
        ...
        # upsert on username (update other fields)
        out.write(
...
print(f"Generated {OUT} with {len(data)} records (entries without username/password were skipped).")
