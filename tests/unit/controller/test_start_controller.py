...
def test_chain_terminal_result(controller_importer) -> None:
    ...
    assert controller.chain_terminal_result(failed_before_missing) == (False, "failed links: two=status:1")
